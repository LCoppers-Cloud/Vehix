...
struct InitialSetupView: View {
    ...
    private func saveSettings() {
        ...
        // CloudKit is now automatically configured for all users
    ...
    private func saveIntegrationPreferences() {
        ...
        if useServiceTitan {
            // Save ServiceTitan preferences to UserDefaults since ServiceTitanConfig is a struct, not a SwiftData model
            UserDefaults.standard.set(true, forKey: "servicetitan_enabled")
            UserDefaults.standard.set(trackWarehouseInventory, forKey: "servicetitan_sync_inventory")
            UserDefaults.standard.set(true, forKey: "servicetitan_sync_technicians")
            UserDefaults.standard.set(true, forKey: "servicetitan_sync_vendors")
            UserDefaults.standard.set(true, forKey: "servicetitan_sync_purchase_orders")
        }
        
        // Samsara preferences
        if useSamsara {
            // Save Samsara preferences to UserDefaults
            UserDefaults.standard.set(true, forKey: "samsara_enabled")
            UserDefaults.standard.set(30, forKey: "samsara_sync_interval_minutes") // Default to 30 minutes
        }
        
        // Built-in location tracking preferences
        if useBuiltInLocationTracking {
            UserDefaults.standard.set(true, forKey: "builtin_location_tracking_enabled")
        }
        
        // Data sharing preferences
        UserDefaults.standard.set(shareInventoryCatalog, forKey: "share_inventory_catalog")
        UserDefaults.standard.set(sharePricingInfo, forKey: "share_pricing_info")
        UserDefaults.standard.set(shareUsageData, forKey: "share_usage_data")
    }
}
