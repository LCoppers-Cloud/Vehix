...
struct TransferStockView: View {
    ...
    @State private var targetVehicles: [AppVehicle] = []
    ...
    private func loadVehicles() {
        ...
        Task {
            do {
                let descriptor = FetchDescriptor<AppVehicle>(sortBy: [SortDescriptor(\AppVehicle.make), SortDescriptor(\AppVehicle.model)])
...
#Preview {
    ...
    let container = try! ModelContainer(
        ...
        AppVehicle.self, AuthUser.self, VehicleAssignment.self,
    ...
    let vehicle1 = AppVehicle(make: "Ford", model: "Transit", year: 2023, licensePlate: "PRE-V1")
    let vehicle2 = AppVehicle(make: "Chevy", model: "Express", year: 2022, licensePlate: "PRE-V2")
