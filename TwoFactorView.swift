    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 30) {
                ...
                VStack(spacing: 20) {
                    // Verification code
                    TextField("", text: $authService.verificationCode)
                        .placeholder(when: authService.verificationCode.isEmpty) {
                            Text("Verification Code").foregroundColor(.white.opacity(0.7))
                        }
                        .padding()
