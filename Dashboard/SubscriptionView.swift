        ...
        ScrollView {
            VStack(spacing: 24) {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Then $125/month for Basic Plan")
                        .font(.title3)
                        .foregroundColor(.secondary)
                    
                    Text("Or save 10% with yearly billing")
                        .font(.subheadline)
                ...
                VStack(alignment: .leading, spacing: 16) {
                    Text("Basic Plan Includes:")
                        .font(.headline)
                        .padding(.bottom, 4)
                    
                    featureRow(icon: "checkmark.circle.fill", text: "2 staff members + unlimited technicians")
                    featureRow(icon: "checkmark.circle.fill", text: "Up to 5 vehicles")
                    featureRow(icon: "checkmark.circle.fill", text: "Complete inventory management")
                    featureRow(icon: "checkmark.circle.fill", text: "Vehicle assignment system")
                    featureRow(icon: "checkmark.circle.fill", text: "Email support")
                    ...
                    featureRow(icon: "star.circle.fill", text: "Pro Plan: $385/month - 4 staff + 1 owner, 15 vehicles")
                    featureRow(icon: "diamond.circle.fill", text: "Enterprise: $50/vehicle - Unlimited everything + direct developer support")
                }
                .padding()
